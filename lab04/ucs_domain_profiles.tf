...
variable "ucs_domain_profiles"  {
  ...
  XXX = {
    ...
    description                 = "test"
    device_model                = ""
    network_connectivity_policy = "XXX-Net_Con_Policy"
    ntp_policy                  = "XXX-NTP-Policy"
    port_policy_fabric_a        = "XXX-Port_Policy-a"
    port_policy_fabric_b        = "XXX-Port_Policy-b"
    serial_number_fabric_a      = ""
    serial_number_fabric_b      = ""
    switch_control_policy       = "XXX-Switch-Control-Policy"
    syslog_policy               = "XXX-Syslog-Policy"
    system_qos_policy           = "XXX-System-QoS-Policy"
    vlan_policy_fabric_a        = "XXX-VLAN-Policy-a"
    vlan_policy_fabric_b        = "XXX-VLAN-Policy-b"
